                        ...
                        new MessageActionRow()
                            .addComponents(
                                new MessageButton()
                                    ...
                                    .setDisabled(settingsLevelIconUnlockDisplay(1, level))
                                    .setStyle('SECONDARY'),
                                new MessageButton()
                                    .setEmoji(icons.lvl5)
                                    .setCustomId('settings_levelicon_lvl5')
                                    .setDisabled(settingsLevelIconUnlockDisplay(5, level))
                                    .setStyle('SECONDARY'),
                                new MessageButton()
                                    .setEmoji(icons.lvl10)
                                    .setCustomId('settings_levelicon_lvl10')
                                    .setDisabled(settingsLevelIconUnlockDisplay(10, level))
                                    .setStyle('SECONDARY'),
                                new MessageButton()
                                    .setEmoji(icons.lvl15)
                                    .setCustomId('settings_levelicon_lvl15')
                                    .setDisabled(settingsLevelIconUnlockDisplay(15, level))
                                    .setStyle('SECONDARY'),
                                new MessageButton()
                                    .setEmoji(icons.lvl20)
                                    .setCustomId('settings_levelicon_lvl20')
                                    .setDisabled(settingsLevelIconUnlockDisplay(20, level))
                                    .setStyle('SECONDARY')
                        ),
                        new MessageActionRow()
                                    .addComponents(
                                new MessageButton()
                                    ...
                                    .setCustomId('settings_levelicon_lvl30')
                                            .setDisabled(settingsLevelIconUnlockDisplay(30, level))
                                    .setStyle('SECONDARY'),
                                new MessageButton()
                                    .setEmoji(icons.lvl40)
                                    .setCustomId('settings_levelicon_lvl40')
                                    .setDisabled(settingsLevelIconUnlockDisplay(40, level))
                                    .setStyle('SECONDARY'),
                                new MessageButton()
                                    .setEmoji(icons.lvl50)
                                    .setCustomId('settings_levelicon_lvl50')
                                    .setDisabled(settingsLevelIconUnlockDisplay(50, level))
                                    .setStyle('SECONDARY'),
                                new MessageButton()
                                    .setEmoji(icons.lvl60)
                                    .setCustomId('settings_levelicon_lvl60')
                                    .setDisabled(settingsLevelIconUnlockDisplay(60, level))
                                    .setStyle('SECONDARY'),
                                new MessageButton()
                                    .setEmoji(icons.lvl70)
                                    .setCustomId('settings_levelicon_lvl70')
                                    .setDisabled(settingsLevelIconUnlockDisplay(70, level))
                                    .setStyle('SECONDARY')
                        ),
                        new MessageActionRow()
                                    .addComponents(
                                new MessageButton()
                                    ...
                                    .setDisabled(settingsLevelIconUnlockDisplay(80, level))
                                    .setStyle('SECONDARY'),
                                new MessageButton()
                                    .setEmoji(icons.lvl90)
                                    .setCustomId('settings_levelicon_lvl90')
                                    .setDisabled(settingsLevelIconUnlockDisplay(90, level))
                                    .setStyle('SECONDARY'),
                                new MessageButton()
                                    .setEmoji(icons.lvl100)
                                    .setCustomId('settings_levelicon_lvl100')
                                    .setDisabled(settingsLevelIconUnlockDisplay(100, level))
                                    .setStyle('SECONDARY')
                        )
                    ]
                });
